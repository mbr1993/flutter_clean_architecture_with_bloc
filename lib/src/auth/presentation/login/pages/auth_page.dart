...
import 'package:flutter_clean_architecture_with_bloc/src/auth/presentation/widgets/form_field.dart';
      ...
      child: BlocListener<AuthCubit, AuthState>(
        listener: (BuildContext context, AuthState state) {
          if (state is AuthSuccess) {
            context.goNamed(RouteNames.users.name);
          }
        ...
        child: Scaffold(
          ...
          body: BlocBuilder<AuthCubit, AuthState>(builder: _bodySection),
        ),
      ),
    );
  }
              ...
              children: [
                customFormField(
                  ...
                  validator: (String? value) {
                    return value != null ? (!value.isValidEmail() ? 'Invalid email' : null) : null;
                  },
                  key: 'email',
                  isSuffixIcon: false,
                  suffixIcon: null,
